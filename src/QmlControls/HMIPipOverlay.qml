...
Item {
    ...
    function _initForItems() {
        var item1IsFull = HMI.loadBoolGlobalSetting(item1IsFullSettingsKey, true)
        if (item1 && item2) {
        ...
        _setPipIsExpanded(HMI.loadBoolGlobalSetting(_pipExpandedSettingsKey, true))
    }
    ...
    function _swapPip() {
        ...
        HMI.saveBoolGlobalSetting(item1IsFullSettingsKey, item1IsFull)
    }

    function _setPipIsExpanded(isExpanded) {
        HMI.saveBoolGlobalSetting(_pipExpandedSettingsKey, isExpanded)
