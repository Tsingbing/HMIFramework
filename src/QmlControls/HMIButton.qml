...
Button {
    ...
    property bool   showBorder:     hmiPal.globalTheme === HMIPalette.Light
    ...
    background: Rectangle {
        ...
        color:          _showHighlight ?
                            hmiPal.buttonHighlight :
                            (primary ? hmiPal.primaryButton : hmiPal.button)
    }
    ...
    contentItem: Item {
        ...
        Text {
            ...
            color:                  _showHighlight ?
                                        hmiPal.buttonHighlightText :
                                        (primary ? hmiPal.primaryButtonText : hmiPal.buttonText)
        }
    }
}
