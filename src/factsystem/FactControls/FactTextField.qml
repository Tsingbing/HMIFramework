    ...
    onEditingFinished: {
        ...
        if (errorString === "") {
            ...
            mainWindow.showComponentDialog(
                        validationErrorDialogComponent, qsTr("Invalid Value"),
                        mainWindow.showDialogDefaultWidth,
                        StandardButton.Save | StandardButton.Cancel)
        }
    }

    onHelpClicked: mainWindow.showComponentDialog(
                       helpDialogComponent, qsTr("值"),
                       mainWindow.showDialogDefaultWidth,
                       StandardButton.Save | StandardButton.Cancel)
