...
/*!
 ...
 HMI has four standard font sizes: default, small, medium and large. The HMI controls use the default font for display and you should use this font
 for most text within the system that is drawn using something other than a standard HMI control. The small font is smaller than the default font.
